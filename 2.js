document.addEventListener("DOMContentLoaded", function() {
    ...
    function displayData() {
        ...
        userData.forEach(function(data, index) {
            table.innerHTML += `
                <tr>
                    <td>${index + 1}</td>
                    <td><img src="${data.profile_pic}" width="50" height="50" alt="image yha hai"></td>
                    <td>${data.id}</td>
                    <td>${data.name}</td>
                    <td>${data.lastName}</td>
                    <td>${data.jobTitle}</td>
    ...
    function addUser() {
        ...
        var newUser = {
            ...
            profile: fileInput.value // You can store image URL here
        };
        ...
        imagePreview.src = ''; // Clear the image preview after adding a user
